...
\titlegraphic{\hfill
  \includegraphics[height=1.3cm]{img/Lassonde_York_V_5C_fit}}
...
% \begin{frame}[fragile,label=typecheckingframe]{Type Checking}
  \begin{itemize}
  \item <1-> $\{x\}+3 \le 7$
...
%     \href{https://web.unitb.org}{\url{web.unitb.org}}
